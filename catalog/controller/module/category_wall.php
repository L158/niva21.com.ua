...
class ControllerModuleCategoryWall extends Controller {
	protected function index($setting) {
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/category-wall.css')) {
			$this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/category-wall.css');
		} else {
			$this->document->addStyle('catalog/view/theme/default/stylesheet/category-wall.css');
		}
		...
		if ($setting['featured_categories'] == 'all') {
			$categories = $this->model_catalog_category_wall->getAllCategoryWallCategories(0);
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/category_wall.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/category_wall.tpl';
		} else {
			$this->template = 'default/template/module/category_wall.tpl';
		}

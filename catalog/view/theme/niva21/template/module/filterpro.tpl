...
<div class="box">
<div class="box-heading filter_container_name" >Выбор по параметрам</div>
<div class="box-content">
<form id="filterpro">
<div style="height: 15px"><a rel="nofollow" class="clear_filter"><?php echo $clear_filter?></a></div>
...
<script id="productTemplate" type="text/x-jquery-tmpl">
	<div>
		{{if thumb}}
		<div class="image"><a rel="nofollow" href="${href}"><img src="${thumb}" title="${name}" alt="${name}"/></a></div>
		{{/if}}
		<div class="name">
		...
		<!--	<div class="extra" style="color: #444;">
				...
				{{/if}}
                {{if model}}
				<div class="model">Каталожный номер:<br /> ${model}</div>
				{{/if}}
				{{if sku}}
				<div class="sku">Артикул: ${sku}</div>
				{{/if}}
		...
		<div class="cart"><a onclick="addToCart('${product_id}','1','${thumb}','${price}','${special}');" class="button"></a></div>
				{{if stock}}
				
				<!-- Old code 
				<div class="stock">Наличие: ${stock}</div>
				-->

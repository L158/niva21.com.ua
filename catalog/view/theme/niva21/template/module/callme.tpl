...
<div class="box">
   ...
   <div class="hide-on" id="callmeform">
         ...
         <input class="text" id="cphone" maxlength="20" size="30" type="text" autocomplete="on" placeholder="<?php echo $entry_phone; ?>" title="<?php echo $entry_phone_title; ?>" onchange="changePhone()" value="+38"/>

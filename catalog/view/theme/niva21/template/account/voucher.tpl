  ...
  <div class="box-container">
    ...
    <table class="form">
      <tr>
        ...
        <td><input class="q2" type="text" name="to_name" value="<?php echo $to_name; ?>" />
      ...
      <tr>
        ...
        <td><input class="q2" type="text" name="to_email" value="<?php echo $to_email; ?>" />
      ...
      <tr>
        ...
        <td><input class="q2" type="text" name="from_name" value="<?php echo $from_name; ?>" />
      ...
      <tr>
        ...
        <td><input class="q2" type="text" name="from_email" value="<?php echo $from_email; ?>" />

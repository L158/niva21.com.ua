  ...
  <div class="product-grid">
    <?php foreach ($products as $product) { ?>
     ...
     <div class="inner-indent">
      ...
      <?php } ?>
      <?php if ($product['sku']) { ?>
      <div class="sku">Артикул: <?php echo $product['sku']; ?></div>
      <?php } ?>
      <?php if ($product['price']) { ?>
      <div class="price">
        Цена: <?php if (!$product['special']) { ?>
      ...
      <?php } ?>
      <div class="cart">
        <input type="button" value="" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button" />
      </div>
...
$('.display').html('<b><?php echo $text_display; ?></b> <div id="list_b"></div> <a id="grid_a" onclick="display(\'grid\');"><?php echo $text_grid; ?></a>');
      ...
      html += '<div class="stock">' + $(element).find('.stock').html() + '</div>';
		...
		$('.display').html('<b><?php echo $text_display; ?></b> <a id="list_a" onclick="display(\'list\');"><?php echo $text_list; ?></a>  <b>/</b> <?php echo $text_grid; ?>');

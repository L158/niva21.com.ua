    ...
    <?php if ($thumb || $images) { ?>
        <div class="fleft left spacing">
          <?php foreach ($images as $image) { ?>
            <div class="zoom-top">      <a rel="nofollow" href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"  data-gal="prettyPhoto[gallery]" ><img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></div>
                          <?php } ?>
          <?php if ($thumb) { ?>
           
          <div class="image"> 
          <a rel="nofollow" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class = 'cloud-zoom' id='zoom1' rel="position: 'right'" >
          <img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
          </a>
          <a rel="nofollow" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>">
          ...
          <div class="image-additional">
            ...
            <?php foreach ($images as $image) { ?>
       <a rel="nofollow" href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo $image['thumb']; ?>' "><img src="<?php echo $image['small']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
            <?php } ?>
          </div>
          <?php } ?>
          <?php if ($review_status) { ?>
            <div class="review">
                    <div><img src="catalog/view/theme/theme_free/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /></div>
                    
            </div>
        <?php } ?>
        
        <div class="sku"><span><?php echo $text_sku; ?></span> <?php echo $sku; ?></div><br />
        </div>
        <?php } ?>
    <div class="extra-wrap">
      <div class="description">
        <?php if ($manufacturer) { ?>
        <span><?php echo $text_manufacturer; ?></span> <a rel="nofollow" href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a><br />
        <?php } ?>
        <span><?php echo $text_model; $model = str_replace(" ", "<br />", $model);?></span> <span class="model-br"><?php echo $model; ?></span><br />
        <!--<div class="sku"><span><?php echo $text_sku; ?></span> <?php echo $sku; ?></div><br />-->
        <?php if ($reward) { ?>
        <span><?php echo $text_reward; ?></span> <?php echo $reward; ?><br />
        <?php } ?>
        <div class="padd-avalib"> <div class="extra-wrap1"> <span class="prod-stock-2"><?php echo $text_stock; ?></span> <div class="prod-stock"><?php echo $stock; ?></div></div></div>
      <?php if ($price) { ?>
      <div class="price">
        ...
        <span class="text-price">Новая цена: </span><span class="price-new"><?php echo $special; ?></span> 
        <?php } ?>
      ...
      <div class="cart">
        ...
        <div class="fast_order_button">
            ...
            <link rel="stylesheet" type="text/css" href="catalog/view/theme/theme_free/stylesheet/fast_order.css" />
                                        <a id="fast_order" class="button-prod">Быстрый заказ</a>
...
<div class="wrapper mb-1">
  <div id="tabs" class="htabs"><a rel="nofollow" href="#tab-description"><?php echo $tab_description; ?></a>
    ...
    <?php } ?>
    <?php if ($tags) { ?>
    <a rel="nofollow" href="#tab-related"><?php echo $text_tags; ?></a>
    <?php } ?>
  </div>
</div>
<div class="wrapper">
  ...
  <div id="tab-related" class="tab-content">
    ...
    <a rel="nofollow" href="<?php echo $tags[$i]['href']; ?>"><?php echo $tags[$i]['tag']; ?></a>,
    <?php } else { ?>
    <a rel="nofollow" href="<?php echo $tags[$i]['href']; ?>"><?php echo $tags[$i]['tag']; ?></a>
    <?php } ?>
    <?php } ?>
